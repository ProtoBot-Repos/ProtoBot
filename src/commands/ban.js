...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!interaction.guild.members.me.permissions.has(0x4)) return await interaction.reply({ content: "I do not have the permission `BAN_MEMBERS` <:deval:811990530706636820>", ephemeral: true });
